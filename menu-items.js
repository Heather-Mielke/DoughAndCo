 ...
 *
 * Order in "All" view: donuts → pastries → muffins-breads → cookies → drinks
 * (same order as filter tabs after "All").
 */
...
const rows = [
  // —— Donuts (wide heroes first, then A–Z by file) ——
  {
  ...
  // —— Pastries (wide feature cards first, then A–Z by file) ——
  {
